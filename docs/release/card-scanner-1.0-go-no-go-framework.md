...
| --- | --- | --- |
| Known deterministic defects | **Open for release evidence**; the six-finding baseline at `a4375df` remains the latest audit snapshot. F01–F03 source remediation is now landed and focused-verified, but the audit has not been rerun against `main`; F04–F06 and the associated runtime/release gates remain open. | [`../audits/defect_review_pass_2.md`](../audits/defect_review_pass_2.md), [`../../app_review_fix_plan.md`](../../app_review_fix_plan.md) |
| Storage, account, and CloudKit continuity | **Not certified**; pass-2 F01/F02 source remediation is landed and focused-verified, while entitled-device behavior, production enrollment, schema inspection, and two-device convergence remain open | [`app_review_fix_plan.md`](../../app_review_fix_plan.md), [`phase-1-integrity-evidence.md`](phase-1-integrity-evidence.md), [`../audits/defect_review_pass_2.md`](../audits/defect_review_pass_2.md) |
