...
This support page covers CardScanner 1.0 on supported iPhone and iPad operating systems.
...
The deployed support page supplies the current response contact and service expectations for the release.
