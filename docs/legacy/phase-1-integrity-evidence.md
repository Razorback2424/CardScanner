...
- Current candidate SHA: `ec7dc6b` — the A4a transient-authority correction
  commit; it is based on the A4a implementation candidate `a819a0a` and frozen
  A2a hardening SHA `8cc1ad1`.
