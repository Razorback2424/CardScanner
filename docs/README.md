...
| Automatic Pokémon set updates | [`plans/automatic_pokemon_catalog_updates_plan.md`](plans/automatic_pokemon_catalog_updates_plan.md) — Slices A–E implemented; F04 automatic discovery and Slice F validation-only/one-off revision-1 authority rehearsal completed 2026-09-19; live signed-authority, physical-device/offline, and production cutover remain open |
