...
| Automatic Pokémon set updates | [`plans/automatic_pokemon_catalog_updates_plan.md`](plans/automatic_pokemon_catalog_updates_plan.md) — Slices A–E implemented; Slice F validation-only and one-off revision-1 remote-authority simulator rehearsal completed 2026-09-19; physical-device/offline and production cutover remain open |
