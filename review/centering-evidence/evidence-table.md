...
| REQ-032 diagnostics and negative-result log | Named E0/E-A diagnostics and experiment ledger exist; stale EA placeholder cleanup and final intentional-diagnostic review remain | [experiments log](experiments-log.md), [diagnostics/EA](diagnostics/EA/summary.json) | PARTIAL |
