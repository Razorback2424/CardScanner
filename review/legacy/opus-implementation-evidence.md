...
> **Legacy archive — historical/superseded snapshot, 2026-09-10.** This evidence records the earlier Luna trust-hardening implementation and dated validation. It is not current centering evidence. Use the [current card-centering plan](../opus-card-centering-implementation-plan.md) and [centering evidence](../centering-evidence/) for active work.
